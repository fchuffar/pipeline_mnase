...
bam_files = c(
  paste0("/home/fchuffar/projects/datashare/", gse, "/", samples, "_end-to-end_trim30_bowtie2_", species, "_", version, "_srt.bam")                        ,
  paste0("/home/fchuffar/projects/datashare/", gse, "/", samples, "_end-to-end_trim30_bowtie2_", species, "_", version, "_srt_mmq0.bam")                   ,
  paste0("/home/fchuffar/projects/datashare/", gse, "/", samples, "_end-to-end_trim30_bowtie2_", species, "_", version, "_srt_mmq1.bam")                   ,
  paste0("/home/fchuffar/projects/datashare/", gse, "/", samples, "_end-to-end_trim30_bowtie2_", species, "_", version, "_srt_mmq30.bam")                  ,
  paste0("/home/fchuffar/projects/datashare/", gse, "/", samples, "_end-to-end_trim60_bowtie2_", species, "_", version, "_srt.bam")                        ,
  paste0("/home/fchuffar/projects/datashare/", gse, "/", samples, "_end-to-end_trim60_bowtie2_", species, "_", version, "_srt_mmq0.bam")                   ,
  paste0("/home/fchuffar/projects/datashare/", gse, "/", samples, "_end-to-end_trim60_bowtie2_", species, "_", version, "_srt_mmq1.bam")                   ,
  paste0("/home/fchuffar/projects/datashare/", gse, "/", samples, "_end-to-end_trim60_bowtie2_", species, "_", version, "_srt_mmq30.bam")
...
bam_files = c(
  paste0("/home/fchuffar/projects/datashare/", gse, "/", samples, "_end-to-end_trim30_bowtie2_", species, "_", version, "_srt_mmq1.bam")                        ,
  paste0("/home/fchuffar/projects/datashare/", gse, "/", samples, "_end-to-end_trim60_bowtie2_", species, "_", version, "_srt_mmq.bam")                        
)
...
# paste0("/home/fchuffar/projects/datashare/", gse, "/", samples, "_end-to-end_trim30_bowtie2_", species, "_", version, "_srt.bam")                        ,
# paste0("/home/fchuffar/projects/datashare/", gse, "/", samples, "_end-to-end_trim30_bowtie2_", species, "_", version, "_srt_mmq30.bam")                  ,
# paste0("/home/fchuffar/projects/datashare/", gse, "/", samples, "_end-to-end_trim30_bowtie2_", species, "_", version, "_fsmin025_fsmax075_srt.bam")      ,
# paste0("/home/fchuffar/projects/datashare/", gse, "/", samples, "_end-to-end_trim30_bowtie2_", species, "_", version, "_fsmin025_fsmax075_srt_mmq30.bam"),
# paste0("/home/fchuffar/projects/datashare/", gse, "/", samples, "_end-to-end_trim30_bowtie2_", species, "_", version, "_fsmin125_fsmax175_srt.bam")      ,
# paste0("/home/fchuffar/projects/datashare/", gse, "/", samples, "_end-to-end_trim30_bowtie2_", species, "_", version, "_fsmin125_fsmax175_srt_mmq30.bam")
...
for (sample in samples) {
  ...
  for (mmq in c(0, 30)) {
    i = i+1
    h = read.table(paste0("hist_frag_size/", sample, "_end-to-end_trim30_bowtie2_", species, "_", version, "_srt_mmq", mmq, ".txt"), stringsAsFactors=FALSE, header=TRUE)
    fact = nb_reads[paste0(sample, "_end-to-end_trim30_bowtie2_", species, "_", version, "_srt_mmq", mmq)] / nb_reads[paste0(sample, "_end-to-end_trim30_bowtie2_", species, "_", version, "_srt_mmq", 0)]
...
plot_samples = function(samples){
  ...
  plot(0, 0, col=0, ylab="", xlab="", ylim=c(0,0.03), xlim=c(0,max_frag_len), main=paste(samples, mmq, collapse=" "), xaxt="n")  
...
for (mmq in c(30, 0)) {
  plot_samples(samples[c(1:3)])
  plot_samples(samples[c(4:6)])
}
...
for (mmq in c(30, 0)) {
  plot_samples(samples[c(1,4)])
  plot_samples(samples[c(2,5)])
  plot_samples(samples[c(3,6)])
}
```
