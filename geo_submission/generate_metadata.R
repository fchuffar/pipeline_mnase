...
samples = read.table(paste0("/bettik/chuffarf/geo_submission/", project, "/md5.", gse, ".bw.geo.txt"))
head(samples)
dim(samples)
...
proc_data_files = read.table(paste0("/bettik/chuffarf/geo_submission/", project, "/md5.", gse, ".bw.geo.txt"))
