...
```{r label="params"}
prefix = "trscr2chrom_mmspg_R_q1234"
```
...
cmd = "plotProfile"
args = paste0("--matrixFile tmp/matrix_", prefix, ".txt.gz --outFileName ", pf_out_filename, "  --perGroup --samplesLabel ", paste0(samples, collapse=" "), " --regionsLabel ", paste0(regions, collapse=" "))
print(paste(cmd, args))
system2(cmd, args)
```
