...
for (sample in samples) {
  ...
  genes_file = "~/projects/datashare/genomes/Saccharomyces_cerevisiae/UCSC/sacCer3/Annotation/Genes/genes.bed"
...
# -rw-r--r-- 1 chuffarf l-iab 767K Dec  2 10:20 /home/chuffarf/projects/datashare/hsspz/cth2b_rep11_end-to-end_trim30_bowtie2_Homo_sapiens_hg38_srt.bam.SAR.bam
# -rw-r--r-- 1 chuffarf l-iab 955K Dec  2 10:20 /home/chuffarf/projects/datashare/hsspz/cth2b_rep12_end-to-end_trim30_bowtie2_Homo_sapiens_hg38_srt.bam.SAR.bam
# -rw-r--r-- 1 chuffarf l-iab 189K Dec  2 10:20 /home/chuffarf/projects/datashare/hsspz/cth2b_rep21_end-to-end_trim30_bowtie2_Homo_sapiens_hg38_srt.bam.SAR.bam
# -rw-r--r-- 1 chuffarf l-iab 160K Dec  2 10:20 /home/chuffarf/projects/datashare/hsspz/cth2b_rep22_end-to-end_trim30_bowtie2_Homo_sapiens_hg38_srt.bam.SAR.bam
# -rw-r--r-- 1 chuffarf l-iab 484K Dec  2 10:20 /home/chuffarf/projects/datashare/hsspz/input_rep10_end-to-end_trim30_bowtie2_Homo_sapiens_hg38_srt.bam.SAR.bam
# -rw-r--r-- 1 chuffarf l-iab 215K Dec  2 10:20 /home/chuffarf/projects/datashare/hsspz/input_rep20_end-to-end_trim30_bowtie2_Homo_sapiens_hg38_srt.bam.SAR.bam


# score_filenames = paste0("/home/chuffarf/projects/datashare/", gse, "/", samples, "_end-to-end_trim30_bowtie2_", species, "_", version, "_srt.bam.SAR.bam")
score_filenames = paste0("/home/chuffarf/projects/datashare/", gse, "/", samples, "_end-to-end_trim30_bowtie2_", species, "_", annotation, "_", version, ".bam")
bam_file = score_filenames[4]
mbam = mscanBam(bam_file)
names(bam[[1]])
...
foo = sapply(locus, function(loci) {
  ...
  nb_reads = sapply(samples, function(sample) {
    bed_filename = paste0("/home/chuffarf/projects/datashare/", gse, "/", sample, "_end-to-end_trim30_bowtie2_", species, "_", version, "_srt.bam.", loci, ".bed")
