...
mamba install -c anaconda -c bioconda -c conda-forge -c r fastqc libxcrypt libxcrypt1 multiqc fastq-screen fastx_toolkit bowtie2 r-base libopenblas bioconductor-geoquery bioconductor-affy bioconductor-biobase r-seqinr r-rcpparmadillo r-devtools r-fastmap r-matrix r-kernsmooth r-catools r-gtools r-nortest r-survival r-beanplot r-gplots r-dbi snakemake=7.32.4 macs3 subread bioconductor-deseq2 bioconductor-annotatr bioconductor-vplotr 
