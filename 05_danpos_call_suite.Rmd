...
thresh_smt = 128
algo="peaks"
rmarkdown::render("35_danpos_custom_call_h2al2_h3_chip.Rmd", output_file=paste0("35_danpos_custom_call_h2al2_h3_chip_", danpos_out_dir, "_", prefix, "_", thresh_smt, "_", algo, ".html"))


danpos_out_dir = "danpos_out_TH2B_chip_input"
prefix = "ChIP_TH2B.bgsub.Fnor"
thresh_smt = 128
rmarkdown::render("35_danpos_custom_call_h2al2_h3_chip.Rmd", output_file=paste0("35_danpos_custom_call_h2al2_h3_chip_", danpos_out_dir, "_", prefix, "_", thresh_smt, ".html"))

danpos_out_dir = "danpos_out_H3_chip_input"
prefix = "ChIP_TH2B.Fnor"
thresh_smt = 128
rmarkdown::render("35_danpos_custom_call_h2al2_h3_chip.Rmd", output_file=paste0("35_danpos_custom_call_h2al2_h3_chip_", danpos_out_dir, "_", prefix, "_", thresh_smt, ".html"))

danpos_out_dir = "danpos_out_TH2B_chip"
prefix = "ChIP_H3.bgsub.Fnor"
thresh_smt = 128
rmarkdown::render("35_danpos_custom_call_h2al2_h3_chip.Rmd", output_file=paste0("35_danpos_custom_call_h2al2_h3_chip_", danpos_out_dir, "_", prefix, "_", thresh_smt, ".html"))

danpos_out_dir = "danpos_out_H3_chip"
prefix = "ChIP_H3.Fnor"
thresh_smt = 128
rmarkdown::render("35_danpos_custom_call_h2al2_h3_chip.Rmd", output_file=paste0("35_danpos_custom_call_h2al2_h3_chip_", danpos_out_dir, "_", prefix, "_", thresh_smt, ".html"))
...
# cd danpos_out_H32b_chip_input/pooled
# ln -s ChIP_H3.bgsub.Fnor.smooth.positions.xls ChIP_H3.bgsub.Fnor_fsmin125_fsmax175_srtsymblink.smooth.positions.xls
# ln -s ChIP_H3.bgsub.Fnor.smooth.positions.xls ChIP_H3.bgsub.Fnor_fsmin025_fsmax075_srtsymblink.smooth.positions.xls
# cd ../../
...
# we choose for nuc a=10 q=20 thresh_smt=96 for nuc
a=10
q=20
z=20
jw=40
...
danpos.py dpos -m 1 -e 1 -jw ${jw} -jd ${jd} -a ${a} -z ${z} -q ${q} -o danpos_out_custom_e1_jw${jw}_jd${jd}_a${a}_z${z}_q${q} S_H2A_end-to-end_trim30_srt_mmq30.bam > danpos_out_custom_e1_jw${jw}_jd${jd}_a${a}_z${z}_q${q}_S_H2A_end-to-end_trim30_srt_mmq30.log &
danpos.py dpos -m 1 -e 1 -jw ${jw} -jd ${jd} -a ${a} -z ${z} -q ${q} -o danpos_out_custom_e1_jw${jw}_jd${jd}_a${a}_z${z}_q${q} S_H31_end-to-end_trim30_srt_mmq30.bam > danpos_out_custom_e1_jw${jw}_jd${jd}_a${a}_z${z}_q${q}_S_H31_end-to-end_trim30_srt_mmq30.log &
danpos.py dpos -m 1 -e 1 -jw ${jw} -jd ${jd} -a ${a} -z ${z} -q ${q} -o danpos_out_custom_e1_jw${jw}_jd${jd}_a${a}_z${z}_q${q} S_H32_end-to-end_trim30_srt_mmq30.bam > danpos_out_custom_e1_jw${jw}_jd${jd}_a${a}_z${z}_q${q}_S_H32_end-to-end_trim30_srt_mmq30.log &
...
samtools view -bq 30 S_H2A_end-to-end_trim30_fsmin125_fsmax175_srt.bam > S_H2A_end-to-end_trim30_fsmin125_fsmax175_srt_mmq30.bam &
samtools view -bq 30 S_H31_end-to-end_trim30_fsmin125_fsmax175_srt.bam > S_H31_end-to-end_trim30_fsmin125_fsmax175_srt_mmq30.bam &
samtools view -bq 30 S_H32_end-to-end_trim30_fsmin125_fsmax175_srt.bam > S_H32_end-to-end_trim30_fsmin125_fsmax175_srt_mmq30.bam &

samtools index S_H2A_end-to-end_trim30_fsmin125_fsmax175_srt_mmq30.bam &
samtools index S_H31_end-to-end_trim30_fsmin125_fsmax175_srt_mmq30.bam &
samtools index S_H32_end-to-end_trim30_fsmin125_fsmax175_srt_mmq30.bam &
...
danpos.py dpos -m 1 -e 1 -jw ${jw} -jd ${jd} -a ${a} -z ${z} -q ${q} -o danpos_out_custom_e1_jw${jw}_jd${jd}_a${a}_z${z}_q${q} S_H2A_end-to-end_trim30_fsmin125_fsmax175_srt_mmq30.bam > danpos_out_custom_e1_jw${jw}_jd${jd}_a${a}_z${z}_q${q}_S_H2A_end-to-end_trim30_fsmin125_fsmax175_srt_mmq30.log &
danpos.py dpos -m 1 -e 1 -jw ${jw} -jd ${jd} -a ${a} -z ${z} -q ${q} -o danpos_out_custom_e1_jw${jw}_jd${jd}_a${a}_z${z}_q${q} S_H31_end-to-end_trim30_fsmin125_fsmax175_srt_mmq30.bam > danpos_out_custom_e1_jw${jw}_jd${jd}_a${a}_z${z}_q${q}_S_H31_end-to-end_trim30_fsmin125_fsmax175_srt_mmq30.log &
danpos.py dpos -m 1 -e 1 -jw ${jw} -jd ${jd} -a ${a} -z ${z} -q ${q} -o danpos_out_custom_e1_jw${jw}_jd${jd}_a${a}_z${z}_q${q} S_H32_end-to-end_trim30_fsmin125_fsmax175_srt_mmq30.bam > danpos_out_custom_e1_jw${jw}_jd${jd}_a${a}_z${z}_q${q}_S_H32_end-to-end_trim30_fsmin125_fsmax175_srt_mmq30.log &


danpos_out_dir = paste0("danpos_out_custom_e1_jw", jw, "_jd", jd, "_a", a, "_z", z, "_q", q, "")
thresh_smt = 256
prefixes = c(
  "S_H2A_end-to-end_trim30_fsmin125_fsmax175_srt_mmq30", 
  "S_H31_end-to-end_trim30_fsmin125_fsmax175_srt_mmq30", 
  "S_H32_end-to-end_trim30_fsmin125_fsmax175_srt_mmq30",   
)
for (prefix in prefixes) {
  rmarkdown::render("28_danpos_custom_call_nuc_mnase_sperm.Rmd", output_file=paste0("28_danpos_custom_call_nuc_mnase_sperm_", danpos_out_dir, "_", prefix, "_", thresh_smt, ".html"))  
}



# we choose for ss a=5 q=40 for ss
a=5
q=40

danpos.py dpos -m 1 -e 1 -jw ${jw} -jd ${jd} -a ${a} -z ${z} -q ${q} -o danpos_out_custom_e1_jw${jw}_jd${jd}_a${a}_z${z}_q${q} S_H2A_end-to-end_trim30_fsmin025_fsmax075_srt_mmq30.bam > danpos_out_custom_e1_jw${jw}_jd${jd}_a${a}_z${z}_q${q}_S_H2A_end-to-end_trim30_fsmin025_fsmax075_srt_mmq30.log
danpos.py dpos -m 1 -e 1 -jw ${jw} -jd ${jd} -a ${a} -z ${z} -q ${q} -o danpos_out_custom_e1_jw${jw}_jd${jd}_a${a}_z${z}_q${q} S_H31_end-to-end_trim30_fsmin025_fsmax075_srt_mmq30.bam > danpos_out_custom_e1_jw${jw}_jd${jd}_a${a}_z${z}_q${q}_S_H31_end-to-end_trim30_fsmin025_fsmax075_srt_mmq30.log
danpos.py dpos -m 1 -e 1 -jw ${jw} -jd ${jd} -a ${a} -z ${z} -q ${q} -o danpos_out_custom_e1_jw${jw}_jd${jd}_a${a}_z${z}_q${q} S_H32_end-to-end_trim30_fsmin025_fsmax075_srt_mmq30.bam > danpos_out_custom_e1_jw${jw}_jd${jd}_a${a}_z${z}_q${q}_S_H32_end-to-end_trim30_fsmin025_fsmax075_srt_mmq30.log
...
algo="positions"
prefix = "pooled_PR.Fnor"
thresh_smt = 0
danpos_out_dir="result"
rmarkdown::render("35_danpos_custom_call_h2al2_h3_chip.Rmd")
```
...
if (!exists("danpos_out_dir")) {
  ...
  jd=100
  danpos_out_dir = paste0("danpos_out_custom_e1_jw", jw, "_jd", jd, "_a", a, "_z", z, "_q", q, "")
  # danpos_out_dir = "danpos_out_custom_e1_jw40_jd100_a10_z20"
  danpos_out_dir = "danpos_out_H3_chip_input"
}
```
