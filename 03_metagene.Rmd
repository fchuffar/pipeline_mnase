...
# write.table(feat[,1:6], file=regions_filenames, sep="\t", quote=FALSE, row.names=FALSE, col.names=FALSE)
#
# head(feat)
# dim(feat)
```
...
# score_filenames
score_filenames = paste0("datashare/", gse, "/", samples, "_end-to-end_trim30_bowtie2_", species, "_", annotation, "_", version, "_srt_", sr_or_pe, "_30_4_RPKM.bw")
brsl = arsl = 5000
bin_size = 100
