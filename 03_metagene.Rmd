...
if (species=="Mus_musculus" & version=="mm10") {
  ...
  stop("genome not Homo_sapiens hg38 nor Mus_musculus mm10 nor Candida_albicans SC5314.A22")
}
```
...
```{r label="tss_feature"}
regions_filenames = paste0("/home/fchuffar/projects/datashare/genomes/", species, "/", annotation, "/", version, "/Annotation/Genes/genes.bed")
regions_filenames
